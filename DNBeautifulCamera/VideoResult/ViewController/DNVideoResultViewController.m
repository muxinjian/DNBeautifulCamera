...
#import "DNVideoResultViewController+Private.h"
#import "DNVideoResultViewController.h"

#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wincomplete-implementation"

@implementation DNVideoResultViewController
...
- (void)showPreview {
    ...
    UIImage *previewImage = [DNAssetHelper videoPreviewImageWithURL:url];
...
- (void)confirmAction:(id)sender {
    ...
    if (self.videos.count == 1) {
        ...
        NSString *exportPath = [DNFileHelper randomFilePathInTmpWithSuffix:@".m4v"];
        [DNAssetHelper mergeVideos:videoPaths toExportPath:exportPath completion:^{
