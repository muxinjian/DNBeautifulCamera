...
#import "DNCameraViewController+UI.h"
...
@implementation DNCameraViewController (UI)
...
- (void)setupCameraView {
    ...
    [self refreshCameraViewWithRatio:[DNCameraManager shareManager].ratio];
...
- (void)setupCapturingButton {
    self.capturingButton = [[DNCapturingButton alloc] init];
...
- (void)setupFilterBarView {
    self.filterBarView = [[DNFilterBarView alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height, self.view.frame.size.width, 0)];
...
- (void)setupCameraTopView {
    self.cameraTopView = [[DNCameraTopView alloc] init];
...
- (void)setupModeSwitchView {
    self.modeSwitchView = [[DNCapturingModeSwitchView alloc] init];
...
- (void)setupRatioBlurView {
    self.ratioBlurView = [[DNVisualEffectView alloc] init];
...
- (void)setupVideoTimeLabel {
    self.videoTimeLabel = [[DNCameraVideoTimeLabel alloc] init];
